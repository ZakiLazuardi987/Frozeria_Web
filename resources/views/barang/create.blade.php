...
<div class="d-flex align-items-center mb-4">
    <a href="{{ route('barang.index') }}" class="btn btn-sm btn-outline-secondary mr-3">
        <i class="fas fa-arrow-left mr-1"></i> Kembali
    </a>
    <h5 class="mb-0 font-weight-bold text-dark">Tambah Barang Baru</h5>
</div>
...
<form action="{{ route('barang.store') }}" method="POST" enctype="multipart/form-data" novalidate>
        ...
        <div class="card-body p-4">
            ...
            <div class="border rounded p-4 text-center"
                ...
                <div id="uploadPlaceholder">
                    ...
                    <p class="text-muted small mt-2 mb-1">Klik untuk memilih foto, atau seret file ke sini</p>
        ...
        <div class="card-body p-4">
            ...
            <div class="form-group mb-0">
                ...
                <textarea class="form-control @error('deskripsi') is-invalid @enderror"
                          ...
                          rows="3"
                          placeholder="Deskripsi singkat tentang barang ini...">{{ old('deskripsi') }}</textarea>
                @error('deskripsi')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
    ...
    <div class="d-flex justify-content-end mb-5">
        <a href="{{ route('barang.index') }}" class="btn btn-outline-secondary px-4 mr-2">Batal</a>
